...
#' @docType data
#' @usage data("seals")
#' @references Cronin et al. 2007. An assessment of population size and distribution of harbor seals in the Republic ofIreland during the moult season in August 2003. Journal of zoology, 273: 131-139
