...
NULL
```
After running `roxygenize()` on the the package directory an `.Rd` file is produced. If you didn't make a pull request or don't have the whole package toolchain to build the package, you can stop here.
